...
public class ShopCardProduct extends RecyclerView.Adapter<ShopCardProduct.MyViewHolder> implements Filterable {
    ...
    public ShopCardProduct(ArrayList<Product> list, OnMeneuClickListnser onLiveTestClickListener, Context context) {
        this.listData = list;
...
//        }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        MaterialTextView tvName,tv_quantity,tvPrice,tvDescription,addCart;
