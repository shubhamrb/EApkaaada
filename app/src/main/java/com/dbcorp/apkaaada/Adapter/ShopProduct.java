...
public class ShopProduct extends RecyclerView.Adapter<ShopProduct.MyViewHolder> implements Filterable {
    ...
    public ShopProduct(ArrayList<Product> list, OnMeneuClickListnser onLiveTestClickListener, Context context) {
        this.listData = list;
