...
public class SearchVendorAdapter extends RecyclerView.Adapter<SearchVendorAdapter.MyViewHolder> implements Filterable {
    ...
    public SearchVendorAdapter(ArrayList<SearchByProduct> menuClassList, OnMeneuClickListnser onLiveTestClickListener, Context context) {
