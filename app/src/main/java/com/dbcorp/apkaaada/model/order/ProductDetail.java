...
public class ProductDetail implements Serializable {
    ...
    @Expose
    private String vendorSelectedProduct;
    ...
    public String getVendorSelectedProduct() {
        return vendorSelectedProduct;
    }

    public void setVendorSelectedProduct(String vendorSelectedProduct) {
        this.vendorSelectedProduct = vendorSelectedProduct;
    }
